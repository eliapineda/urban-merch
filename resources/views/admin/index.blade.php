    ...
    <div class="flex justify-center p-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mt-4 md:mt-8 text-center">
            ...
            <a href="{{ route('admin.products') }}"
                class="w-full md:w-64 min-h-48 bg-gray-900 rounded-xl shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 p-6 flex items-center justify-center text-center text-3xl font-bold text-white uppercase font-title">
                PRODUCTOS
            </a>
